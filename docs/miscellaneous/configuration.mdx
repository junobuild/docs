...
The satellite configuration must include at least an `id`. Additionally, it can support multiple identifiers if you plan to deploy your satellite across different environments (see related chapters below in this documentation).
