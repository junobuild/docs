...
| `authSubscribe` | Subscribe to auth state changes     | [`src/components/Auth.jsx`](https://github.com/junobuild/create-juno/blob/main/templates/react-example/src/components/Auth.jsx)     | [Subscription](../build/authentication/development#subscription)      |
