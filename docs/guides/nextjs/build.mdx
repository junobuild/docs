---
sidebar_label: Build
description: Learn how to integrate Juno with Next.js. Follow our quickstart guide to set up your development environment, configure your project, and start building with Juno.
keywords:
  [Juno, Next.js, deployment, hosting, production, guide, static exports]
...
<WhatsNext path={"/docs/guides/nextjs/deploy"} />
