...
module.exports = nextConfig;module.exportspnpm create juno -- --template nextjs-examplenpm create juno@latest -- --template nextjs-starternpm create juno@latest -- --template nextjs-exampleyarn create juno -- --template nextjs-example---
id: nextjs
title: Next.js
