...
Your hosting configuration is defined in the Juno [configuration](../../reference/configuration.mdx) file, which is automatically created when you run [juno init](../../reference/cli#init) or [juno deploy](../../reference/cli#deploy) for the first time.

---

## How do you apply your changes?

To apply any changes, execute the [juno config](../../reference/cli#config) command with the CLI.
