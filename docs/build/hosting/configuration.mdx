...
Your hosting configuration is defined in the Juno [configuration](../../miscellaneous/configuration.mdx) file, which is automatically created when you run [juno init](../../miscellaneous/cli#init) or [juno deploy](../../miscellaneous/cli#deploy) for the first time.

---

## How do you apply your changes?

To apply any changes, execute the [juno config](../../miscellaneous/cli#config) command with the CLI.
