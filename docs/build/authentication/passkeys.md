...
- Combine Passkeys with other providers (like [Google](google.mdx) or [Internet Identity](internet-identity.md)) to cover both mainstream and decentralized use cases.
