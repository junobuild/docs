...
| ----------------------- | ------------------------------------------ | ---------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `maxTimeToLiveInMillis` | `BigInt(4 * 60 * 60 * 1000 * 1000 * 1000)` | —                      | Specifies the duration for the session (defaults to **4 hours**). It's **important** to note that this duration remains constant, whether the users are active or inactive.                                                                                                                                                                                                                                        |
...
await signIn({
  ii: {
    options: {
      maxTimeToLiveInMilliseconds: 1000 * 60 * 30, // 30 minutes
      onProgress: ({ step, state }) => {
        console.log("Step:", step, "State:", state);
      },
