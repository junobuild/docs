...
import Hosting from "./cli/hosting.md";
...
import HostingClear from "./cli/hosting-clear.md";
...
import ConfigApply from "./cli/config-apply.md";
...
import ConfigInit from "./cli/config-init.md";
...
juno hosting deploy --mode staging
```
...
juno hosting deploy --profile team --mode staging
```
