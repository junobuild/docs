...
The `runner` field allows you to customize how the emulator container is run via Docker.

| Option   | Required | Description                                                               | Default                                                                  |
| -------- | -------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| type     | ✅       | Container runtime used (currently only `"docker"` is supported).          |                                                                          |
| image    |          | Docker image used to start the emulator.                                  | `junobuild/skylab:latest`                                                |
