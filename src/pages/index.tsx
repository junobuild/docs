  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          content="Build Web3 Apps Faster Than Ever Before. No backend code required. 100% on-chain with minimal carbon impact."
          name="description"
        />
        <meta content="Juno" property="og:title" />
        <meta
          content="Build Web3 Apps Faster Than Ever Before."
          property="og:description"
        />
        <meta content="website" property="og:type" />
        <meta content="https://juno.build" property="og:url" />
        <meta
          content="https://juno.build/img/social-image.jpg"
          property="og:image"
        />
